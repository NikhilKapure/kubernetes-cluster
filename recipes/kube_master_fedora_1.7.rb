...
# _____________________________________________________________________________________________
#%w(telnet-0.17-60.el7 docker-1.12.6-32.git88a4867.el7.centos.x86_64 kubelet-1.7.3-1.x86_64 kubeadm-1.7.3-1.x86_64 kubectl-1.7.3-1.x86_64 kubernetes-cni-0.5.1-0.x86_64 ntp).each do |pkg|
#  yum_package pkg do
#    action :install
#  end
#end
